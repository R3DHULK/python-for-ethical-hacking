...
try:
	...
	print("\033[93m [*] The following WiFi interfaces are available:")
	for index, item in enumerate(check_wifi_result):
		print(f"  {index} - {item}")

	# Ensure the WiFi interface selected is valid. Simple menu with interfaces to select from.
	while True:
		wifi_interface_choice = input("\033[92m [+] Please select the interface you want to use for the attack: ")
		try:
			if check_wifi_result[int(wifi_interface_choice)]:
				break
		except:
			print("\033[91m [-] Please enter a number that corresponds with the choices available.")
	...
	print("\033[95m [+] WiFi adapter connected!\n [*] Now let's kill conflicting processes:")
	...
	try:
		while True:
			...
			print("\033[92m No |\tBSSID              |\tChannel|\tESSID                         |")
			print("\033[92m ___|\t___________________|\t_______|\t______________________________|")
